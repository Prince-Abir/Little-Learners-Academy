   <div class="container-fluid bg-dark bg-gradient text-white-50 footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
       <div class="container py-5">
           <div class="row g-5">
               ...
               <div class="col-lg-3 col-md-6">
                   ...
                   <a class="btn btn-link text-white-50" href="/admin/index.php">Admin</a>
                   ...
                   <a class="btn btn-link text-white-50" href="/admin/index.php">Admin Login</a>
               </div>
               <div class="col-lg-5 col-md-6">
                   <h3 class="text-white mb-4">Photo Gallery</h3>
                   <div class="row g-2 pt-2">
                       <div class="col-4">
                           <img class="img-fluid rounded bg-light p-1" src="/img/image11.jpg" alt="">
                       </div>
                       <div class="col-4">
                           <img class="img-fluid rounded bg-light p-1" src="/img/image8.jpg" alt="">
                       </div>
                       <div class="col-4">
                           <img class="img-fluid rounded bg-light p-1" src="/img/image3.jpg" alt="">
                       </div>
                       <div class="col-4">
                           <img class="img-fluid rounded bg-light p-1" src="/img/image9.jpg" alt="">
                       </div>
                       <div class="col-4">
                           <img class="img-fluid rounded bg-light p-1" src="/img/image4.jpg" alt="">
                       </div>
                       <div class="col-4">
                           <img class="img-fluid rounded bg-light p-1" src="/img/image10.jpg" alt="">
                       </div>
                   </div>
               </div>
