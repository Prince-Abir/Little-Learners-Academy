...
?>
  ...
  <head>
    ...
    <title>Little Learners Academy | Add Sub admin</title>
                  ...
                  <form name="subadmin" method="post">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Enter email" pattern="[0-9]{11}" title="11 numeric characters only" required>
                      </div>
