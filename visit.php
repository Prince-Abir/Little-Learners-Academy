...
<body>
                ...
                <div class="row g-0">
                        ...
                        <div class="h-100 d-flex flex-column justify-content-center p-5">
                            ...
                            <form method="post">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <button class="btn submit-button w-100 py-3" type="submit" name="submit">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100 rounded" src="/img/image5.jpg" style="object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Back to Top -->
    <a href="#" class="btn btn-lg submit-button btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
    </div>
